...
<body class="gradient-custom min-vh-100 d-flex align-items-center">
            ...
            <div class="col-md-8 col-lg-6">
                <div class="card shadow-lg">
                    <div class="card-body p-5">
                        ...
                        <form action="{{ route('admin.contacts.update', $contacts) }}" method="POST" id="contactsForm">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-4">
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-lg floating-input ps-3" 
                                           name="name" placeholder="Name" value="{{ $contacts->name }}" required>
                            ...
                            <div class="mb-4">
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-lg floating-input ps-3" 
                                           name="address" placeholder="Address" value="{{ $contacts->address }}" required>
                                    <div class="icon-container">
                            ...
                            <div class="mb-4">
                                <div class="input-group">
                                    <input type="gmail" class="form-control form-control-lg floating-input ps-3" 
                                           name="gmail" placeholder="Deskripsi" value="{{ $contacts->gmail }}" required>
                                    <div class="icon-container">
                                        <i class="fas fa-align-left"></i>
                                    </div>
                                </div>
                            ...
                            <div class="mb-4">
                                <div class="input-group">
                                    <input type="texts" class="form-control form-control-lg floating-input ps-3" 
                                           name="whatsapp" placeholder="whatsapp" value="{{ $contacts->whatsapp }}" required>
                                    <div class="icon-container">
                                        <i class="fas fa-align-left"></i>
                                    </div>
                                </div>
    ...
    <script>
        document.getElementById('contactsForm').addEventListener('input', function() {
