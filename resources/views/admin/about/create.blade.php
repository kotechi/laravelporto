                    ...
                    <div class="card-body p-5">
                        ...
                        <form action="{{ route('admin.about.store')}}" method="POST" id="aboutForm">
                            ...
                            <div class="mb-4">
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-lg floating-input ps-3" 
                                           name="freelance" placeholder="freelance" required>
                                    <div class="icon-container">
                                        <i class="fas fa-align-left"></i>
                                    </div>
                                </div>
                            ...
                            <div class="mb-4">
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-lg floating-input ps-3" 
                                           name="deskripsi2" placeholder="Deskripsi 2" required>
                                    <div class="icon-container">
                                        <i class="fas fa-align-left"></i>
                                    </div>
                                </div>
                            ...
                            <div class="mb-4">
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-lg floating-input ps-3" 
                                           name="educational_background" placeholder="educational_background" required>
                                    <div class="icon-container">
                                        <i class="fas fa-align-left"></i>
                                    </div>
                                </div>
