            ...
            <div class="col-md-8 col-lg-6">
                <div class="card shadow-lg">
                    <div class="card-body p-5">
                        ...
                        <form action="{{ route('admin.projects.update', $projects) }}" 
                        method="POST" 
                        id="projectsForm" 
                      ...
                      <div class="mb-4">
                          <div class="input-group">
                              <input type="text" class="form-control form-control-lg floating-input ps-3" 
                                     name="name" placeholder="Name" value="{{ $projects->name }}" required>
                      ...
                      <div class="mb-4">
                          <div class="input-group">
                              <input type="text" class="form-control form-control-lg floating-input ps-3" 
                                     name="description" placeholder="Deskripsi" value="{{ $projects->description }}" required>
                              <div class="icon-container">
                      ...
                      <div class="mb-4">
                          <div class="input-group">
                              <input type="link" class="form-control form-control-lg floating-input ps-3" 
                                     name="link" placeholder="Link" value="{{ $projects->link }}" required>
                              <div class="icon-container">
                      ...
                      <div class="mb-4">
                          <div class="input-group">
                              <input type="date" class="form-control form-control-lg floating-input ps-3" 
                                     name="date" placeholder="Date" value="{{ $projects->date }}" required>
                          </div>
                      </div>
