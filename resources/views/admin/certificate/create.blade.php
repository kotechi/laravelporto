                ...
                <div class="card shadow-lg">
                    <div class="card-body p-5">
                        <div class="text-center mb-4">
                            <h2 class="fw-bold text-primary mb-2">Form certificate</h2>
                        ...
                        <form action="{{ route('admin.certificate.store')}}" method="POST" id="aboutForm" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                <div class="input-group">
                                    <input type="text" class="form-control form-control-lg floating-input ps-3" 
                                           name="issued_by" placeholder="Issued_by" required>
                                    <div class="icon-container">
                                        <i class="fas fa-heading"></i>
                                    </div>
                                </div>
                            ...
                            <div class="mb-4">
                                <div class="input-group">
                                    <input type="date" class="form-control form-control-lg floating-input ps-3" 
                                           name="issued_at" placeholder="Issued_at"  required>
                                    <div class="icon-container">
                                        <i class="fas fa-heading"></i>
                                    </div>
                                </div>
